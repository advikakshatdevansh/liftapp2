...
class NotificationModel {
  ...
  factory NotificationModel.fromJson(String id, Map<String, dynamic> map) {
    return NotificationModel(
      ...
      recipientIds: map.containsKey('recipientIds')
  ...
  static NotificationModel fromQuerySnapshot(
